...
public class MyPool {
    private static final Logger logger = Logger.getLogger(MyPool.class.getName());
    ...
    public MyPool(int corePoolSize, int maxPoolSize, long keepAliveTime,
    ...
    private static class CustomRejectionHandler implements RejectedExecutionHandler {
        ...
        public void rejectedExecution(Runnable r, ThreadPoolExecutor executor) {
            ...
            // Implement different rejection policies here
        }
    }
} 